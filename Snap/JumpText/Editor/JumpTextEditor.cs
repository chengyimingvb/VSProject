...
{
    [CustomEditor(typeof(JumpText)), CanEditMultipleObjects]
    public class JumpTextEditor : Editor
    {
        //References:
        JumpText dn;
        TextMeshPro textA;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Selection.gameObjects != null && Selection.gameObjects.Length > 1)
            {
                foreach (GameObject gameObject in Selection.gameObjects)
                {
                    ...
                    {
                        JumpText other = gameObject.GetComponent<JumpText>();
                        if (other != null)
                        {
                            other.UpdateText();
                        }
