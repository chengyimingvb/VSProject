...
namespace CYM
{
    public class SysConst
    {
        ...
        public static readonly string RPath_Uni = "Assets/CYMUni/";
        ...
        public static readonly Color Color_BuffPositive = BaseUIUtil.FromHex("#136700FF");
        public static readonly Color Color_BuffNegative = BaseUIUtil.FromHex("#670000FF");
        public static readonly Color Color_BuffAll = BaseUIUtil.FromHex("#280067FF");
        #endregion
